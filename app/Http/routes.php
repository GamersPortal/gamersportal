...
Route::group(['prefix' => 'admin', 'middleware' => 'admin'], function () {
  ...
  Route::get('/games', [
    'as' => 'AdminGameIndex',
    'uses' => 'Admin\GamesController@index'
  ]);

  Route::get('/games/search', [
    'as' => 'AdminGameSearch',
    'uses' => 'Admin\GamesController@search'
  ]);

  Route::get('/games/create', [
    'as' => 'AdminGameCreate',
    'uses' => 'Admin\GamesController@create'
  ]);

  Route::post('/games', [
    'as' => 'AdminGameStore',
    'uses' => 'Admin\GamesController@store'
  ]);

  Route::get('/games/{game}', [
    'as' => 'AdminGameShow',
    'uses' => 'Admin\GamesController@show'
  ]);

  Route::get('/games/{game}/edit', [
    'as' => 'AdminGameEdit',
    'uses' => 'Admin\GamesController@edit'
  ]);

  Route::patch('/games/{game}', [
    'as' => 'AdminGameUpdate',
    'uses' => 'Admin\GamesController@update'
  ]);

  Route::get('/games/{game}/delete', [
    'as' => 'AdminGameDelete',
    'uses' => 'Admin\GamesController@delete'
  ]);

  Route::delete('/games/{game}', [
    'as' => 'AdminGameDestroy',
    'uses' => 'Admin\GamesController@destroy'
  ]);
